    ...
    "node_modules/chosen-js/chosen.jquery.js"(exports) {
      (function() {
        ...
        AbstractChosen = function() {
          function AbstractChosen2(form_field, options1) {
          ...
          AbstractChosen2.prototype.choice_label = function(item) {
          ...
          AbstractChosen2.prototype.label_click_handler = function(evt) {
            if (this.is_multiple) {
          ...
          AbstractChosen2.prototype.results_option_build = function(options) {
          ...
          AbstractChosen2.prototype.result_add_option = function(option) {
          ...
          AbstractChosen2.prototype.result_add_group = function(group) {
          ...
          AbstractChosen2.prototype.winnow_results = function(options) {
          ...
          AbstractChosen2.prototype.get_search_regex = function(escaped_search_string) {
          ...
          AbstractChosen2.prototype.search_string_match = function(search_string, regex) {
            var match;
          ...
          AbstractChosen2.prototype.keydown_checker = function(evt) {
            var ref, stroke;
          ...
          AbstractChosen2.prototype.clipboard_event_checker = function(evt) {
            if (this.is_disabled) {
              return;
            }
            return setTimeout(function(_this) {
          ...
          AbstractChosen2.prototype.include_option_in_results = function(option) {
          ...
          AbstractChosen2.prototype.search_results_touchstart = function(evt) {
            this.touch_started = true;
            return this.search_results_mouseover(evt);
          };
          AbstractChosen2.prototype.search_results_touchmove = function(evt) {
            this.touch_started = false;
            return this.search_results_mouseout(evt);
          };
          AbstractChosen2.prototype.search_results_touchend = function(evt) {
            if (this.touch_started) {
              return this.search_results_mouseup(evt);
            }
          };
          AbstractChosen2.prototype.outerHTML = function(element) {
            var tmp;
          ...
          AbstractChosen2.prototype.get_single_html = function() {
            return '<a class="chosen-single chosen-default">\n  <span>' + this.default_text + '</span>\n  <div><b></b></div>\n</a>\n<div class="chosen-drop">\n  <div class="chosen-search">\n    <input class="chosen-search-input" type="text" autocomplete="off" />\n  </div>\n  <ul class="chosen-results"></ul>\n</div>';
          };
          AbstractChosen2.prototype.get_multi_html = function() {
            return '<ul class="chosen-choices">\n  <li class="search-field">\n    <input class="chosen-search-input" type="text" autocomplete="off" value="' + this.default_text + '" />\n  </li>\n</ul>\n<div class="chosen-drop">\n  <ul class="chosen-results"></ul>\n</div>';
          };
          AbstractChosen2.prototype.get_no_results_html = function(terms) {
        ...
        Chosen = function(superClass) {
          ...
          Chosen2.prototype.on_ready = function() {
          ...
          Chosen2.prototype.update_results_content = function(content) {
          ...
          Chosen2.prototype.single_set_selected_text = function(text) {
            if (text == null) {
          ...
          Chosen2.prototype.get_search_field_value = function() {
          ...
          Chosen2.prototype.trigger_form_field_change = function(extra) {
    ...
    "node_modules/bootstrap-datepicker/dist/js/bootstrap-datepicker.js"(exports) {
      (function(factory) {
        ...
        Datepicker.prototype = {
          ...
          _trigger: function(event2, altdate) {
...
%o`, message, error2, detail);
   ...
   */
  __publicField(cancelar_vacio_es_eliminar_controller_default, "targets", [
    "boton",
    "determinador"
  ]);
  ...
  __publicField(sindocaut_controller_default, "targets", [
    "numerodocumento",
    "id"
  ]);
  ...
  var edad_controller_default = class extends Controller {
    ...
    actualizarEdad(event2) {
      ...
      if (fechaCaso.getMonth() < fechaNacimiento.getMonth() || fechaCaso.getMonth() === fechaNacimiento.getMonth() && fechaCaso.getDate() < fechaNacimiento.getDate()) {
        edad--;
      }
      if (edad > 0) {
